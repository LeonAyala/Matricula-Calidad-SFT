<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="frmGHorarioAtencion.aspx.cs" Inherits="CapaPresentacion.frmGHorarioAtencion" %>
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="input-group">
                            <asp:TextBox ID="txtDNI" runat="server" CssClass="form-control" MaxLength="8" placeholder="Ingresar el DNI del Medico" required="true"></asp:TextBox>
                    ...
                    <div class="bootstrap-timepicker">
                        <div class="form-group">
                            <label>Hora Inicio:</label>
                             <br />
                            <label style="font-weight:400">Horario de Atención: 06:00 - 22:00</label>
                            <div class="input-group">
...
<asp:Content ID="Contend3" ContentPlaceHolderID="footer" runat="server">
