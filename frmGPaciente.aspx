<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="frmGPaciente.aspx.cs" Inherits="CapaPresentacion.frmGPaciente" ClientIDMode="Static" %>
            ...
            <div class="col-md-6">
                <div class="box box-primary">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <asp:TextBox ID="txtNroDocumento" runat="server" Text="" CssClass="form-control" placeholder="Ingrear DNI del Paciente" required="true"></asp:TextBox>
                        ...
                        <div class="form-group">
                            <asp:TextBox ID="txtEdad" runat="server" Text="" CssClass="form-control" required="true"></asp:TextBox>
            ...
            <div class="col-md-6">
                <div class="box box-primary">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <asp:TextBox ID="txtCorreo" runat="server" Text="" CssClass="form-control" required="true"></asp:TextBox>
                        <asp:RegularExpressionValidator ID="evCorreo" runat="server" ErrorMessage="Correo Incorrecta" ControlToValidate="txtCorreo" ForeColor="#FF3300" ValidationExpression=".{0,40}" ValidationGroup="DatosRequeridos"></asp:RegularExpressionValidator>
                            </div>
                        ...
                        <div class="form-group">
                            <asp:TextBox ID="txtTelefono" runat="server" Text="" CssClass="form-control" placeholder="Ej.999999999" required="true"></asp:TextBox>
                        ...
                        <div class="form-group">
                            <asp:TextBox ID="txtDireccion" runat="server" Text="" CssClass="form-control" required="true"></asp:TextBox>
                        ...
                        <div class="form-group">
                            <asp:TextBox ID="txtnuser" runat="server" Text="" CssClass="form-control" required="true"></asp:TextBox>
                        <asp:RegularExpressionValidator ID="evNuser" runat="server" ErrorMessage="Usuario Incorrecta" ControlToValidate="txtnuser" ForeColor="#FF3300" ValidationExpression=".{0,40}" ValidationGroup="DatosRequeridos"></asp:RegularExpressionValidator>
                            </div>
                         <div class="form-group">
                            <label>PASSWORD</label>
                        </div>
                        <div class="form-group">
                            <asp:TextBox ID="txtclave" runat="server" Text="" CssClass="form-control" TextMode="Password" required="true"></asp:TextBox>
                            <asp:RegularExpressionValidator ID="evClave" runat="server" ErrorMessage="Clave 1 Incorrecta" ControlToValidate="txtclave" ForeColor="#FF3300" ValidationExpression=".{0,40}" ValidationGroup="DatosRequeridos"></asp:RegularExpressionValidator>
                        </div>
                        <div class="form-group">
                            <label>CONFIRMAR PASSWORD</label>
                        </div>
                        <div class="form-group">
                            <asp:TextBox ID="txtclave2" runat="server" Text="" CssClass="form-control" TextMode="Password" required="true"></asp:TextBox>
                            <asp:RegularExpressionValidator ID="evClave2" runat="server" ErrorMessage="Clave 2 Incorrecta" ControlToValidate="txtclave2" ForeColor="#FF3300" ValidationExpression=".{0,40}" ValidationGroup="DatosRequeridos"></asp:RegularExpressionValidator>
                       </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <asp:TextBox ID="txtModalCorreo" runat="server" Text="" CssClass="form-control"></asp:TextBox>
                    </div>
                </div>
