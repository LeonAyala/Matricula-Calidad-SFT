<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="frmGUsuario.aspx.cs" Inherits="CapaPresentacion.frmGUsuario" ClientIDMode="Static"%>
                        ...
                        <div class="box box-primary">
                            <div class="box-body">
                                ...
                                <div class="input-group">
                                    <asp:TextBox ID="txtDNI" CssClass="form-control" runat="server" MaxLength="8" required="true" placeholder="Ingrear DNI del Empleado"></asp:TextBox>
                                    <div class="input-group-btn">
                                        <asp:Button ID="btnBuscar" runat="server" CssClass="btn btn-danger" 
                                            Text="BUSCAR"  />
                                    </div>
                                </div>
                                <br />
            ...
            <div class="col-md-4">
                <div class="box box-primary">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <asp:TextBox ID="txtNUsuario" runat="server" Text="" CssClass="form-control" required="true"></asp:TextBox>
                        </div>
            ...
            <div class="col-md-4">
                <div class="box box-primary">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <asp:TextBox ID="txtClave" runat="server"  TextMode="Password" Text="" CssClass="form-control" required="true"></asp:TextBox>
                        </div>
