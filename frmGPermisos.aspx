<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="frmGPermisos.aspx.cs" Inherits="CapaPresentacion.frmGPermisos" %>
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:Label ID="lblPadreMenu" runat="server" Text='<%#((Eval("SubMenu") as List<CapaPresentacion.CapaEntidades.Menu>).Count > 0)? (Eval("SubMenu") as List<CapaPresentacion.CapaEntidades.Menu>)[0].Nombre : "" %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
